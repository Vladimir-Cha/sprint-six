...
// Обработчик для получения задач - GET /tasks
...
// Обработчик для отправки на сервер - POST /tasks
...
// Обработчик для получения задачи по ID GET /tasks/{id}
...
// Обработчик удаления задачи по ID DELETE /tasks/{id}
